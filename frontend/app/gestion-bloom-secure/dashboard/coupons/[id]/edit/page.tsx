        ...
        <div className="w-full px-4 sm:px-8 lg:px-12 xl:px-24 max-w-[1400px] mx-auto py-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 md:gap-6">
          <div>
            ...
            <p className="text-[14px] text-gray-500">
              Mettez ├á jour les d├®tails de votre promotion et les r├¿gles de remboursement
            </p>
          </div>
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full md:w-auto mt-2 md:mt-0">
            ...
            >
              ...
              {isSaving ? '├ënregistrement...' : 'Enregistrer le coupon'}
            </button>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 items-start">
          ...
          <div className="bg-white rounded-[16px] p-5 sm:p-8 shadow-[0_2px_15px_rgba(0,0,0,0.02)]">
            <div className="flex items-center gap-2 text-[#da2966] mb-8">
              ...
              <h2 className="text-[16px] sm:text-[18px] font-serif font-bold tracking-wide">Validit├®</h2>
            </div>
            
            <div className="space-y-6">
              <div>
                <label className="block text-[11px] font-bold text-[#444] mb-2">Date de d├®but</label>
          ...
          <div className="bg-white rounded-[16px] p-5 sm:p-8 shadow-[0_2px_15px_rgba(0,0,0,0.02)]">
            <div className="flex items-center gap-2 text-[#da2966] mb-8">
              ...
              <h2 className="text-[16px] sm:text-[18px] font-serif font-bold tracking-wide">Param├®tres de r├®duction</h2>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div>
                <label className="block text-[11px] font-bold text-[#444] mb-2">Type de r├®duction</label>
                <AdminSelect
                  variant="compact"
                  value={discountType}
              ...
              <div>
                <label className="block text-[11px] font-bold text-[#444] mb-2">Valeur de la r├®duction</label>
                <div className="relative">
                  <input
                    type="number"
                    placeholder="0"
