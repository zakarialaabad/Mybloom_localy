...
function productToCard(p: Product) {
  ...
  return {
    ...
    imageUrl,
    secondaryImageUrl,
    category: ['parfum', 'gommage corporel', 'beurre corporel', 'maquillage'].includes(p.category?.name?.toLowerCase() ?? '') ? (p.product_type?.name ?? p.category?.name) : p.category?.name,
    productType: ['parfum', 'gommage corporel', 'beurre corporel', 'maquillage'].includes(p.category?.name?.toLowerCase() ?? '') ? (p.brand?.name ?? p.product_type?.name ?? '') : (p.product_type?.name ?? ''),
    defaultSizeLabel,
    defaultSizeId,
    defaultVariantPrice,
