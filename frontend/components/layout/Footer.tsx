      ...
      <div className="border-t border-gray-100">
        <div className="container mx-auto px-4 py-5 flex flex-col-reverse sm:flex-row items-center justify-between gap-3">
          <p className="text-[12px] text-gray-400 text-center">
            ...
            <a
              href="https://www.instagram.com/azmarketing_laayoune?igsh=Y21pbGVlOTVsdW0w"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#da2966] hover:text-[#b8224f] hover:underline transition-colors font-medium"
            >
              AZ Marketing
            </a>
          </p>
