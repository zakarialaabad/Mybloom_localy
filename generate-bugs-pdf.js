...
async function generatePDF() {
  const mdPath  = path.join(__dirname, 'BUGS_RESOLVED.md');
  const pdfPath = path.join(__dirname, 'BUGS_RESOLVED.pdf');
...
<div class="cover">
  ...
  <div class="cover-title">Bugs Resolved — Admin Panel</div>
  <div class="cover-version">Debugging Report — March 2026</div>
  <div class="cover-meta">
    Project: Bloom Parfums<br/>
    Stack: Next.js 14 + Laravel 11 + MySQL<br/>
    Date: March 12, 2026<br/>
    Status: All Issues Resolved
  </div>
  <div class="cover-divider"></div>
  <div class="cover-meta" style="font-size:10px; max-width:500px; line-height:1.8;">
    Plain-language guide to every bug encountered<br/>
    and how each one was diagnosed and fixed.<br/>
    Covers 5 bugs across PHP, Laravel Sanctum,<br/>
    Next.js middleware, and browser cookie handling.
  </div>
</div>
...
<div class="content">
  ...
  await page.pdf({
    ...
    headerTemplate: `<div style="font-size:8px; color:#999; width:100%; text-align:right; padding-right:14mm; font-family:sans-serif;">Bloom Parfums — Bugs Resolved Report — March 2026</div>`,
